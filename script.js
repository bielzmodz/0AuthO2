window.addEventListener('load', () => {
    ...
    document.querySelector('.verify-btn').addEventListener('click', function() {
        window.location.href = `https://discord.com/oauth2/authorize?client_id=1278802821923344456&response_type=code&redirect_uri=https%3A%2F%2Fbielzmodz.github.io%2FOAuth2%2F%23%2Fauth%2Fdiscord%2Fcallback&scope=identify+guilds.join`;
    });
});
